    ...
    <main class="p-6">
        ...
        <div id="popup" class="fixed inset-0 flex items-center justify-center hidden">
            ...
            <form action="/checkout" method="POST">
                ...
                <input type="text" required name="name" placeholder="Your Name" class="w-full border-gray-300 rounded-md p-2">
                </div>
                <div class="mb-4">
                <label class="block text-sm font-medium mb-1">Address</label>
                <input type="text" required name="address" placeholder="Your Address" class="w-full border-gray-300 rounded-md p-2">
                </div>
                <div class="mb-4">
                <label class="block text-sm font-medium mb-1">Phone Number</label>
                <input type="text" required name="phone" placeholder="Your Phone" class="w-full border-gray-300 rounded-md p-2">
                </div>
