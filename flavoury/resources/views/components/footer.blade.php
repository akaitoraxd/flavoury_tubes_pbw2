<footer class="bg-[#F1E4C3] text-center">
        <div class="space-y-2 py-7 border-b-4 border-[#9B978D] flex flex-col justify-center items-center">
            ...
            <p class="lg:px-96 px-10">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Perferendis tenetur molestias facere dolores libero sit non numquam nostrum possimus rem consectetur fuga quaerat facilis nemo, totam ipsum culpa. Enim, cupiditate!</p>
        </div>
